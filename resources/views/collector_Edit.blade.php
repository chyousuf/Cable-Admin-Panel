                    ...
                    <div class="panel panel-default card-view">
                        ...
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <div class="form-wrap">
                                    <form method="post" action="{{url('/Edit-Collector/'.$collector_Edit[0]->id)}}" >
                                        {{csrf_field()}}
                                        <div class="form-group">
                                            <label class="control-label mb-10 text-left">Name</label>
                                            <input type="text" name="name" class="form-control" value="{{$collector_Edit[0]->name}}" placeholder="Name">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label mb-10 text-left" for="example-email">Father name</label>
                                            <input type="text" id="example-email" name="father_name" value="{{$collector_Edit[0]->father_name}}" class="form-control" placeholder="Father name">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label mb-10 text-left">Phone number</label>
                                            <input type="text" class="form-control"  name="phone_number" placeholder="Phone number" value="{{$collector_Edit[0]->phone_number}}">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label mb-10 text-left">Address </label>
                                            <input type="text" value="{{$collector_Edit[0]->address}}" name="address" class="form-control" placeholder="Address">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label mb-10 text-left">Region</label>
                                            <input type="text" name="region" value="{{$collector_Edit[0]->region}}" class="form-control" placeholder="Region">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label mb-10 text-left">Total Payment Given To Owner</label>
                                            <input type="text" class="form-control" name="total_payment_given_to_owner" value="{{$collector_Edit[0]->total_payment_given_to_owner}}"  placeholder="Amount Paid">
                                        </div>
                                        <br>
                                        <br>
