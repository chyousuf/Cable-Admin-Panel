                ...
                <div class="panel panel-default card-view">
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                <form method="post" action="{{url('/Edit-Customer/'.$customer_Edit[0]->id)}}" >
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        <label class="control-label mb-10 text-left">Name</label>
                                        <input type="text" name="name" class="form-control" value="{{$customer_Edit[0]->name}}" placeholder="Name" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label mb-10 text-left" for="example-email">Father name</label>
                                        <input type="text" id="example-email" name="father_name" value="{{$customer_Edit[0]->father_name}}" class="form-control" placeholder="Father name" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label mb-10 text-left">Phone number</label>
                                        <input type="text" class="form-control"  name="phone_number" placeholder="Phone number" value="{{$customer_Edit[0]->phone_number}}" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label mb-10 text-left">Address </label>
                                        <input type="text" value="{{$customer_Edit[0]->address}}" name="address" class="form-control" placeholder="Address" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label mb-10 text-left">Region</label>
                                        <input type="text" name="region" value="{{$customer_Edit[0]->region}}" class="form-control" placeholder="Region" required>
                                    </div>


                                    <div class="form-group">
                                        <label class="control-label mb-10 text-left">Mountly Amount</label>
                                        <input type="text" class="form-control" name="monthly_amount" value="{{$customer_Edit[0]->monthly_amount}}"  placeholder="Monthly Amount">
                                    </div>

                                    <div class="form-group mt-30 mb-30">
                                        <label class="control-label mb-10 text-left">Payment Status</label>
                                        <select name="payment_status" class="form-control">
                                            @if($customer_Edit[0]->monthly_amount == 'paid' )
