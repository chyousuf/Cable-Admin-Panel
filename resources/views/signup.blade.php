		...
		<div class="wrapper pa-0">
			<header class="sp-header">
				...
				<div class="form-group mb-0 pull-right">
					...
					<a class="inline-block btn btn-info btn-rounded btn-outline" href="{{route('loginview')}}">Sign In</a>
				</div>
										...
										<div class="form-wrap">
											<form method="post" action="{{route('register')}}">
												...
												<div class="form-group">
													...
													<input type="text"  name="username" class="form-control" required="" id="exampleInputName_1" placeholder="Username">
												</div>
												<div class="form-group">
